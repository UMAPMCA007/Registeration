    ...
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('reg') }}">
            ...
            <div>
                ...
                <x-jet-input id="fname" class="block mt-1 w-full" type="text" name="fname" :value="old('name')" required autofocus autocomplete="name" />
            </div>
            <div>
                <x-jet-label for="lname" value="{{ __('Last Name') }}" />
                <x-jet-input id="lname" class="block mt-1 w-full" type="text" name="lname" :value="old('name')" required autofocus autocomplete="name" />
            </div>
